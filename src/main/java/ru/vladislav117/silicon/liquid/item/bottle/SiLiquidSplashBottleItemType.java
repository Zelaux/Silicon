...
/**
 * Тип предмета "бросательная бутылка для жидкостей".
 */
public class SiLiquidSplashBottleItemType extends SiItemType {
    /**
     * Создание новой бросательной бутылки для жидкостей.
     *
     * @param name Имя бутылки
     */
    public SiLiquidSplashBottleItemType(String name, SiTextLike displayName) {
        super(name, Material.SPLASH_POTION);
        ...
        interactions = new SiLiquidSplashBottleItemInteractions();
     ...
     * @param name Имя бутылки
     */
    public SiLiquidSplashBottleItemType(String name, String displayName, SiStyleLike displayNameStyle) {
     ...
     * @param name Имя бутылки
     */
    public SiLiquidSplashBottleItemType(String name, String displayName) {
